...
export async function generateReport(complexityReport, splits) {
  ...
  const reportDir = path.join(process.cwd(), '.pr-surgeon');
...
<head>
  ...
  <title>PR-Surgeon X-Ray Report</title>
  <style>
...
<body>
  ...
  <div class="container">
    ...
    <div class="header fade-in">
      <h1>🔬 PR-Surgeon X-Ray Report</h1>
      <div class="tagline">Diagnostic scan of your Pull Request complexity</div>
      <div class="timestamp">Generated: ${new Date().toISOString()} | PR-Surgeon v1.0.0</div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <p>Generated by <strong>PR-Surgeon</strong> v1.0.0 — X-ray your Pull Requests</p>
